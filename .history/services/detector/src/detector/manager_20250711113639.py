...
class DetectorManager:
    ...
    async def progress(self,session:str,total:int,progress:int,message:Optional[str]=None):
        dts = DetectorTrainingSession(detector=self.detector.id,total=total,progress=progress,message=message)

...
from common.rpc.trainer_pb2 import  TrainImageObjectCountByDetectorRequest, TrainImageObjectCountByDetectorResponse, TrainImageObjectListRequest, TrainImageObjectListResponse, TrainImageObjectRemoveRequest, TrainImageObjectRemoveResponse, TrainImageObjectRequest, TrainImageObjectResponse, TrainImageObjectToDetectorRequest, TrainImageObjectToDetectorResponse, TrainImageObjectUpdateRequest, TrainImageObjectUpdateResponse, TrainSessionCreateRequest, TrainSessionCreateResponse, TrainSessionStatus as PTrainSessionStatus, TrainSessionUpdateRequest, TrainSessionUpdateResponse

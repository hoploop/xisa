...
from common.rpc.storage_pb2_grpc import add_StorageServicer_to_server
import grpc
...
from storage.service import StorageService, StorageServiceConfig
...
config = StorageServiceConfig.factory(SERVICE_CONF,env)
...
async def main():    
    ...
    add_StorageServicer_to_server(service, server)

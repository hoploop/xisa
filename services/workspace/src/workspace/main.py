...
from common.rpc.workspace_pb2_grpc import add_WorkspaceServicer_to_server
from workspace.service import WorkspaceService, WorkspaceServiceConfig
...
config = WorkspaceServiceConfig.factory(SERVICE_CONF,env)
...
async def main():    
    ...
    add_WorkspaceServicer_to_server(service, server)

...
class DetectorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.suggestStep = channel.unary_unary(
                ...
                _registered_method=True)
        self.trainResult = channel.unary_unary(
        ...
        self.detectorImage = channel.unary_unary(
                ...
                _registered_method=True)
        self.detectContours = channel.unary_unary(
                '/Detector/detectContours',
                request_serializer=common_dot_rpc_dot_detector__pb2.DetectContoursRequest.SerializeToString,
                response_deserializer=common_dot_rpc_dot_detector__pb2.DetectContoursResponse.FromString,
                _registered_method=True)
...
class DetectorServicer(object):
    ...
    def detectContours(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DetectorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'trainResult': grpc.unary_unary_rpc_method_handler(
            ...
            'detectContours': grpc.unary_unary_rpc_method_handler(
                    servicer.detectContours,
                    request_deserializer=common_dot_rpc_dot_detector__pb2.DetectContoursRequest.FromString,
                    response_serializer=common_dot_rpc_dot_detector__pb2.DetectContoursResponse.SerializeToString,
            ),
    }
...
class Detector(object):
    ...
    def detectContours(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Detector/detectContours',
            common_dot_rpc_dot_detector__pb2.DetectContoursRequest.SerializeToString,
            common_dot_rpc_dot_detector__pb2.DetectContoursResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

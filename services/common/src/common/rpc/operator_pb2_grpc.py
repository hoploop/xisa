...
from common.rpc import operator_pb2 as common_dot_rpc_dot_operator__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in common/rpc/operator_pb2_grpc.py depends on'
...
class OperatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ask = channel.unary_unary(
                '/Operator/ask',
                request_serializer=common_dot_rpc_dot_operator__pb2.Question.SerializeToString,
                response_deserializer=common_dot_rpc_dot_operator__pb2.Answer.FromString,
                _registered_method=True)
...
def add_OperatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ask': grpc.unary_unary_rpc_method_handler(
                    servicer.ask,
                    request_deserializer=common_dot_rpc_dot_operator__pb2.Question.FromString,
                    response_serializer=common_dot_rpc_dot_operator__pb2.Answer.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Operator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Operator', rpc_method_handlers)
...
class Operator(object):
    ...
    def ask(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Operator/ask',
            common_dot_rpc_dot_operator__pb2.Question.SerializeToString,
            common_dot_rpc_dot_operator__pb2.Answer.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

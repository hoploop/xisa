...
class TrainSessionRemoveRequest(_message.Message):
    __slots__ = ("user", "id")
...
class TrainSessionRemoveResponse(_message.Message):
...
class TrainSessionUpdateRequest(_message.Message):
    __slots__ = ("user", "id", "status", "error", "results")
    USER_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    error: str
    results: str
    def __init__(self, user: _Optional[str] = ..., id: _Optional[str] = ..., status: _Optional[str] = ..., error: _Optional[str] = ..., results: _Optional[str] = ...) -> None: ...

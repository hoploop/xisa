...
from common.rpc.trainer_pb2_grpc import add_TrainerServicer_to_server
from trainer.service import TrainerService, TrainerServiceConfig
...
config = TrainerServiceConfig.factory(SERVICE_CONF,env)
...
async def main():    
    ...
    add_TrainerServicer_to_server(service, server)

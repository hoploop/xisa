...
from common.rpc.auth_pb2_grpc import add_AuthServicer_to_server
...
config = AuthServiceConfig.factory(SERVICE_CONF,env)
...
async def main():    
    ...
    add_AuthServicer_to_server(service, server)

...
from common.rpc.detector_pb2_grpc import add_DetectorServicer_to_server
from detector.service import DetectorService, DetectorServiceConfig
...
config = DetectorServiceConfig.factory(SERVICE_CONF,env)
...
async def main():    
    ...
    add_DetectorServicer_to_server(service, server)

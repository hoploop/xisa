...
@Component({
  selector: 'app-detector-label-select',
  standalone: false,
  templateUrl: './detector-label-select.component.html',
  styleUrl: './detector-label-select.component.scss'
})
export class DetectorLabelSelectComponent extends BaseComponent implements OnInit {

        ...
        switch (value.type){
          ...
          case MouseClickEventTypeEnum.MouseClick:
            ...
            if (value.button == MouseButton.Left){
              ...
              return this.ctx.translate.instant("workspace.record.action.types.mouse_click_middle",pars); //position
            }else{
              return this.ctx.translate.instant("workspace.record.action.types.mouse_click_right",pars); //position
            }
            ...
            case MouseDoubleClickEventTypeEnum.MouseDoubleClick:
              ...
              if (value.button == MouseButton.Left){
                return this.ctx.translate.instant("workspace.record.action.types.mouse_double_click_left",pars); //position
              }else if (value.button == MouseButton.Middle){
                return this.ctx.translate.instant("workspace.record.action.types.mouse_double_click_middle",pars); //position
              }else{
                return this.ctx.translate.instant("workspace.record.action.types.mouse_double_click_right",pars); //position
              }

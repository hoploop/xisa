...
import { DetectorSelectorModalComponent } from '@detect/detector-selector-modal/detector-selector-modal.component';
import { OperatorChatModalComponent } from '../../operator/operator-chat-modal/operator-chat-modal.component';

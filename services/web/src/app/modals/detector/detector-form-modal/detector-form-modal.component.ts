...
@Component({
  selector: 'app-detector-form-modal',
  standalone: false,
  templateUrl: './detector-form-modal.component.html',
  styleUrl: './detector-form-modal.component.scss',
})
export class DetectorFormModalComponent extends BaseComponent {

...
from common.rpc.operator_pb2_grpc import add_OperatorServicer_to_server
from xoperator.service import OperatorService, OperatorServiceConfig
...
config = OperatorServiceConfig.factory(SERVICE_CONF,env)
...
async def main():    
    ...
    add_OperatorServicer_to_server(service, server)
